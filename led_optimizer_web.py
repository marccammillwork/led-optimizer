...
if st.button("Optimize All Orders"):
    ...
    for _, row in df_in.iterrows():
        ...
        for c in cols[1:]:
            ...
            except: st.error(f"Invalid run '{val}' in order {o_no}"); st.stop()
    ...
    # Cutoffs expander (must be dedented to this level)
    ...
    # Export ZIP of CSVs (including Cutoffs)
    buf = io.BytesIO()
